...
LevelController.Components = {}
for _, v in pairs(componentsFolder:WaitForChild("Others", 10):GetChildren()) do
	LevelController.Components[v.Name] = require(v)
end
LevelController.GetComponent = require(componentsFolder["Get()"])
LevelController.SetComponent = require(componentsFolder["Set()"])
