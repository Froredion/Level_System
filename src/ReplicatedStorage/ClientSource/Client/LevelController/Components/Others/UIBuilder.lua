...
function module:CreateProgressBar(properties)
	...
	container.Size = properties.Size or UDim2.new(1, 0, 0, 20)
...
function module:CreateButton(properties)
	...
	button.TextSize = properties.TextSize or UI_DEFAULTS.TextSize
...
function module:CreateCollapsibleSection(properties)
	...
	local contentFrame = self:CreateStyledFrame({
		Name = "ContentFrame",
		Size = UDim2.new(1, 0, 0, properties.ContentHeight or 100),
	...
	headerButton.Activated:Connect(function()
		...
		if isExpanded then
			container.Size =
				UDim2.new(container.Size.X.Scale, container.Size.X.Offset, 0, 40 + (properties.ContentHeight or 100))
			headerButton.Text = "▼ " .. (properties.Title or "Section")
		else
			container.Size = UDim2.new(container.Size.X.Scale, container.Size.X.Offset, 0, 40)
			headerButton.Text = "▶ " .. (properties.Title or "Section")
		end
...
function module:CreateTooltip(element, tooltipText, properties)
	...
	element.MouseEnter:Connect(function()
		...
		tooltip.Position = UDim2.new(0, mouse.X + 10, 0, mouse.Y - 25)
