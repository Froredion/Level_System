...
LevelService.Components = {}
for _, v in pairs(componentsFolder:WaitForChild("Others", 10):GetChildren()) do
	LevelService.Components[v.Name] = require(v)
end
LevelService.GetComponent = require(componentsFolder["Get()"])
LevelService.SetComponent = require(componentsFolder["Set()"])
